...
const Detail: React.FC = () => {
  ...
  const { addToCart, checkToCart }: BasketContextInterface | any =
    useBasketContext();
          ...
          <div className="detail">
            ...
            <div className="detail__text">
              ...
              <div className="detail__text__btns">
                {checkToCart(oneProduct.id) ? (
                  <div className="added">
                    <button className="detail__text__btns__addedToCart">
                      Added to Cart
                    </button>
                    <button onClick={()=>{
                      navigate('/basket')
                    }} className="openBasket">Open Basket</button>
                  </div>
                ) : (
                  <button
